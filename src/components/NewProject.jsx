...
import { TbResize, TbTextResize } from "react-icons/tb";
            ...
            <div className="shadow-xl rounded-lg md:w-96 w-full">
              ...
              >
                <div className="flex justify-end">
                  <p className="bg-white text-black p-1 px-2 text-sm rounded-full border-[3px] border-gray-300/80">{value.launch}</p>
                </div>
              ...
              <div className="">
                ...
                <div className="flex gap-10 p-3 border-t text-gray-400">
                  <div className="flex items-center gap-2 "><FaBed className="text-xl"/>{value.size}</div>
                  <div className="flex items-center gap-2 "><TbTextResize className="text-lg"/> {value.sqrt}</div>
                </div>
              </div>
            </div>
          );
